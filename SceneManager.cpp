...
void SceneManager::sphereIntersect(std::vector<sphere> & spheres, Ray & r, glm::vec3 & intersectionPoint ,glm::vec3 & pixelcolor,
...
void SceneManager::molllerTrombore(std::vector<tri> triangles, Ray & r, glm::vec3 & intersectionPoint, glm::vec3 & pixelcolor, int & id) {
...
void SceneManager::setAreaLight(std::vector<glm::vec3>  & room) {
...
void SceneManager::setRoom(std::vector<glm::vec3>  & room) {
...
void SceneManager::setBox(std::vector<glm::vec3>  & room) {
...
void SceneManager::setTriangles(std::vector<glm::vec3>  & room, std::vector<SceneManager::tri> & triangles) {
	tri t;
	glm::vec3 u, v;
...
void SceneManager::setSpheres(std::vector<SceneManager::sphere> & S) {
...
std::vector<SceneManager::tri> SceneManager::getTriangles() {
	return triangles;
}
std::vector<SceneManager::sphere> SceneManager::getSpheres() {
	return spheres;
}
